<template>
  <div>
    <PageHeader title="Ditto+ Ingestion Queue" description="Ingestion QC queue for Ditto+ label services releases." />

    <DataTable
      title="Ditto+ Ingestion QC"
      :columns="columns"
      :rows="ingestionPlusQueue"
      row-key="id"
      :page="page"
      :per-page="10"
      :total="65"
...
import { ingestionPlusQueue } from '../../data/mockQc'
