<template>
  <div>
    <PageHeader title="Licensing Ditto+ RLS" description="Ditto+ RLS users with uncleared licensing that require manual review." />

    <DataTable
      title="Uncleared Users"
      :columns="columns"
      :rows="unclearedRlsUsers"
      row-key="id"
    >
      <template #toolbar>
...
import { unclearedRlsUsers } from '../../data/mockQc'
